      ...
      <main className="h-full max-w-5xl mx-auto flex flex-col items-center gap-y-12 lg:gap-y-32 pb-8 pt-24 px-4">
        ...
        <div className="flex flex-col lg:flex-row w-full gap-x-8 gap-y-12">
            ...
            <label className="flex flex-row gap-x-2 w-[16em]">
              ...
              <span>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setKeyLvl(
                      Math.min(Math.max(1, parseInt(e.target.value)), 25)
                    )
                  }
                  type="number"
                  value={keyLvl}
          ...
          <div className="flex flex-col gap-y-4 z-10">
            <p>
              The Loth-Divine scale is perfect to tell at a glance how well
              geared you are for a dungeon, with values ranging from Loth (0)
